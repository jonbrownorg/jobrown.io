...
var rssFetchAndDisplay = {
	aFeeds: [[['hot-news'],['The latest News headlines'],[''],['#']]],
	iCurrentFeedsItem: 0,
	aNews: new Array(),
	iCurrentNewsItem: 0,
	tTM: null,
	...
	Create: function(req)
		...
		oTickerCont.innerHTML = "\n\r"+'<table width=510 height=19 border="0" cellpadding="0" cellspacing="0" class="'+r.sState+'">'+"\n\r"+'<tr><td id="tic-item"><a href="'+r.aNews[r.iCurrentNewsItem].url+'">'+r.aNews[r.iCurrentNewsItem].title+'</a></td></tr>'+"\n\r"+'</table>'+"\n\r";
