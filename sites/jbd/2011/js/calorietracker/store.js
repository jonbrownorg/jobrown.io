...
function updateValue(id){
    ...
    if(id == "single"){
        ...
        document.getElementById("paypal-name").value = "Calorie Tracker Single License";
        document.getElementById("product-name").innerHTML = "Calorie Tracker";
        document.getElementById("paypal-number").value = "1";
 ...
 if(id == "double"){
        ...
        document.getElementById("paypal-name").value = "Calorie Tracker Double License";
        document.getElementById("product-name").innerHTML = "Calorie Tracker";
        document.getElementById("paypal-number").value = "1";
    ...
    if(id == "family"){
        ...
        document.getElementById("paypal-name").value = "Calorie Tracker Family License";
        document.getElementById("product-name").innerHTML = "Calorie Tracker";
        document.getElementById("paypal-number").value = "1";
